...
{% include image.html url="/imgs/posts/bypass_aslr_dep_buffer_overflow.webp" description="Finding the offset for a buffer overflow attack by trial-and-error" %}



I usually test this with an address that calls a specific function or jumps back to the start of the program (**0x400566**)

{% include image.html url="/imgs/posts/bypass_aslr_dep_main_addr.webp" description="The 'main' address is used to call the program multiple times and supply multiple payloads" %}


Should you succeed, it will print twice the same message:

{% include image.html url="/imgs/posts/bypass_aslr_dep_call_twice.webp" description="Running the same program twice to prevent ASLR re-randomization" %}
...
{% include image.html url="/imgs/posts/bypass_aslr_dep_payload_leak_puts.webp" description="Leaking the address of puts@libc" %}
...
{% include image.html url="/imgs/posts/bypass_aslr_dep_sh_address.webp" description="Offsets of various 'sh' strings inside libc (radare2)" %}
