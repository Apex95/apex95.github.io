...
{% include image.html url="/imgs/posts/bypass_aslr_dep_buffer_overflow.png" description="Finding the offset for a buffer overflow attack by trial-and-error" %}



I usually test this with an address that calls a specific function or jumps back to the start of the program (**0x400566**)

{% include image.html url="/imgs/posts/bypass_aslr_dep_main_addr.png" description="The 'main' address is used to call the program multiple times and supply multiple payloads" %}


Should you succeed, it will print twice the same message:

{% include image.html url="/imgs/posts/bypass_aslr_dep_call_twice.png" description="Running the same program twice to prevent ASLR re-randomization" %}
...
{% include image.html url="/imgs/posts/bypass_aslr_dep_ldd.png" description="Running ldd reveals different mapping addresses of libc each time the process starts" %}
...
{% include image.html url="/imgs/posts/bypass_aslr_dep_payload_leak_puts.png" description="Leaking the address of puts@libc" %}
...
{% include image.html url="/imgs/posts/bypass_aslr_dep_sh_address.png" description="Offsets of various 'sh' strings inside libc (radare2)" %}
